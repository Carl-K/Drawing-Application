...
class Ellipse extends AbstractShape {
	...
	Ellipse(Point upperLeftHandCornerPointIn, int widthIn, int heightIn, ShapeColor primaryColorIn, ShapeColor secondaryColorIn, ShapeShadingType shapeShadingTypeIn)
	{
